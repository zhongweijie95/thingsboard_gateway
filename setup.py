...
setup(
    ...
    packages=['thingsboard_gateway', 'thingsboard_gateway.gateway', 'thingsboard_gateway.storage',
              ...
              'thingsboard_gateway.connectors.bacnet.bacnet_utilities', 'thingsboard_gateway.connectors.odbc', 'thingsboard_gateway.connectors.lora',
              'thingsboard_gateway.connectors.rest', 'thingsboard_gateway.connectors.snmp',
              'thingsboard_gateway.connectors.lora.cayennelpp',
              ...
              'thingsboard_gateway.extensions.rest',  'thingsboard_gateway.extensions.snmp',  'thingsboard_gateway.extensions.lora'
              ],
    install_requires=[
        'jsonpath-rw',
        'regex',
